...
import com.lotus.lotusSPM.security.JwtAuthenticationEntryPoint;
import com.lotus.lotusSPM.security.JwtAuthenticationFilter;
        ...
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/actuator/**")
                    .permitAll()
                .antMatchers(HttpMethod.GET, "/api/opportunities/**")
                    .permitAll()
                .anyRequest()
                    .authenticated();
